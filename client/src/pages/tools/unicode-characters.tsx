...
const UNICODE_BLOCKS: UnicodeBlock[] = [
  ...
  },
  {
    ...
    description: "More Latin extensions",
  },
  {
  ...
  },
  {
    ...
    description: "Cyrillic script (Russian, Bulgarian, etc.)",
  },
  {
    name: "Arabic",
    start: 0x0600,
    end: 0x06ff,
    description: "Arabic script and symbols",
  },
  { name: "Hebrew", start: 0x0590, end: 0x05ff, description: "Hebrew script" },
  {
    ...
    description: "Hindi, Sanskrit, and other scripts",
  },
  {
    name: "Chinese CJK",
    start: 0x4e00,
    end: 0x4e7f,
    description: "Chinese, Japanese, Korean characters (sample)",
  },
  {
    name: "Hiragana",
    start: 0x3040,
  ...
  },
  {
    ...
    description: "Circles, squares, triangles",
  },
  {
    name: "Mathematical Operators",
    start: 0x2200,
    end: 0x22ff,
    description: "Math symbols and operators",
  },
  { name: "Arrows", start: 0x2190, end: 0x21ff, description: "Arrow symbols" },
  {
    ...
    description: "Line drawing characters",
  },
  {
    name: "Block Elements",
    start: 0x2580,
    end: 0x259f,
    description: "Block and shading characters",
  },
  {
  ...
  },
  {
    ...
    description: "Decorative symbols and characters",
  },
  {
    name: "Emoticons",
    start: 0x1f600,
    end: 0x1f64f,
    description: "Emoji faces and gestures",
  },
  {
    name: "Transport Symbols",
    start: 0x1f680,
    end: 0x1f6ff,
    description: "Vehicle and transport emoji",
  },
  {
    name: "Symbols and Pictographs",
    start: 0x1f300,
    end: 0x1f5ff,
    description: "Weather, objects, and symbols",
  },
];
...
const POPULAR_CATEGORIES = {
  ...
  "Math Symbols": [
    0x00b1, 0x00d7, 0x00f7, 0x2260, 0x2264, 0x2265, 0x221e, 0x2211, 0x220f,
    0x221a,
  ],
  Arrows: [
  ...
  "Stars & Hearts": [
    0x2605, 0x2606, 0x2665, 0x2660, 0x2663, 0x2666, 0x2764, 0x1f496, 0x1f497,
  ],
  Punctuation: [
    0x00a1, 0x00bf, 0x2026, 0x2013, 0x2014, 0x201c, 0x201d, 0x2018, 0x2019,
  ],
...
export default function UnicodeCharacters() {
  ...
  const [viewMode, setViewMode] = useState<
    "block" | "category" | "search" | "custom" | "all"
  >("block");
  ...
  const getCategoryCharacters = (category: string): string[] => {
    const codePoints =
      POPULAR_CATEGORIES[category as keyof typeof POPULAR_CATEGORIES] || [];
            ...
            <CardContent className="space-y-4">
              ...
              {viewMode === "custom" && (
                <div className="space-y-2">
                  ...
                  {customRange.start &&
                  customRange.end &&
                  getCustomRangeTotalPages(customRange.start, customRange.end) >
                    1 ? (
                    <div className="space-y-3 mt-4">
                      <div className="text-sm text-slate-600 dark:text-slate-400">
                        <div>
                          Page {(customRangePage + 1).toLocaleString()} of{" "}
              ...
              <div className="text-xs text-slate-600 dark:text-slate-400">
                <p>
                  <strong>Characters shown:</strong> {currentCharacters.length}
                </p>
                {viewMode === "block" && (
                  <p className="mt-1">
                    {
                      UNICODE_BLOCKS.find(b => b.name === selectedBlock)
                        ?.description
                    }
                  </p>
                )}
