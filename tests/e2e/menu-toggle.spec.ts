...
test.describe("Menu Toggle Functionality", () => {
  ...
  test("should toggle mobile menu on homepage with menu button click", async ({
    page,
  }) => {
    // Set mobile viewport
    ...
    // Verify mobile menu (Sheet) is initially closed
  ...
  test("should toggle mobile menu on tool pages with menu button click", async ({
    page,
  }) => {
